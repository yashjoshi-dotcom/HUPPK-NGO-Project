...
export default function GameList() {
  ...
  // Game data
  const games = [
    { id: '1', title: 'Picture Quiz', icon: 'images-outline', color: '#D8B5FF', iconColor: '#C084FC' },
    { id: '2', title: 'Sorting Game', icon: 'swap-horizontal-outline', color: '#FFDE59', iconColor: '#FACC15' },
    { id: '3', title: 'Emotion Game', icon: 'happy-outline', color: '#87CEFA', iconColor: '#60A5FA' },
    { id: '4', title: 'Memory Game', icon: 'grid-outline', color: '#FFB6C1', iconColor: '#F87171' },
  ];
